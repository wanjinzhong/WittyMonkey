...
<form id="add-form" class="layui-form">
    ...
    <table class="form_table" style="width: 350px">
        <tr>
            ...
            <td><input type="number" name="money" id="money" class="layui-input" onblur="validateMoney(this)" value="${editReimburseApply.money}"/></td>
        </tr>
        <tr>
            <td><label class="layui-form-label"><fmt:message key="reimburse.apply_note"/></label></td>
            <td><textarea id="applyNote" name="applyNote" class="layui-textarea" onblur="validateNote(this)">${editReimburseApply.applyUserNote}</textarea></td>
        </tr>
    </table>
</form>
<div id="btnGroup">
