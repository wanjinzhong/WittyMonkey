...
<script type="text/javascript" src="js/outstock_manage.js"></script>
<!-- 根据设置动态加载js语言 -->
...
<div>
    ...
    <div id="main">
        <i class="newBtn layui-icon layui-btn layui-btn-radius layui-btn-normal" onclick="showOutStock()">&#xe61f;
            <fmt:message key="outstock.add"/></i>
