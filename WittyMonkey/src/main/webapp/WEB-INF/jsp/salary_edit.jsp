...
<head>
    ...
    <script type="text/javascript" src="js/salary_edit.js"></script>
    <!-- 根据设置动态加载js语言 -->
    ...
    <form id="add_form">
        ...
        <table class="form_table" style="width: 600px; padding-top: 20px">
            ...
            <tr>
                ...
                <td colspan="3"><textarea class="layui-textarea" name="note" id="note" onblur="validateNote(this)">${salary.note}</textarea></td>
            </tr>
        </table>
    </form>
    <div id="btnGroup">
