...
<script type="text/javascript" src="js/materiel_type_edit.js"></script>
<!-- 根据设置动态加载js语言 -->
...
<form id="add_form">
    ...
    <table class="form_table">
        ...
        <tr>
            ...
            <td><input type="text" class="layui-input" name="name" value="${editMaterielType.name}"
                       id="name" onblur="validateMaterielTypeName('update',this)"></td>
        </tr>
        <tr>
            <td><label class="layui-form-label"><fmt:message key="note"/></label></td>
            <td><textarea class="layui-textarea" name="note" id="note" onblur="validateNote(this)">${editMaterielType.note}</textarea></td>
        </tr>
    </table>
</form>
<div id="btnGroup">
