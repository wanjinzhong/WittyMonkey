        ...
        try {
            ...
            switch (mod) {
                ...
                case 2:
                    ...
                    break;
                case 3:
                    result = (lastNum == 9) ? true : false;
                    break;
                case 4:
                    result = (lastNum == 8) ? true : false;
                    break;
                case 5:
                    result = (lastNum == 7) ? true : false;
                    break;
                case 6:
                    result = (lastNum == 6) ? true : false;
                    break;
                case 7:
                    result = (lastNum == 5) ? true : false;
                    break;
                case 8:
                    result = (lastNum == 4) ? true : false;
                    break;
                case 9:
                    result = (lastNum == 3) ? true : false;
                    break;
                case 10:
                    result = (lastNum == 2) ? true : false;
                    break;
            }
