...
insert into `menu` (`id`, `description`, `entry_datetime`, `name`, `entry_id`) values('3','checkin',NULL,'checkin',NULL);
insert into `menu` (`id`, `description`, `entry_datetime`, `name`, `entry_id`) values('4','materiel',NULL,'materiel',NULL);
insert into `menu` (`id`, `description`, `entry_datetime`, `name`, `entry_id`) values('5','inventory',NULL,'inventory',NULL);
...
insert into `menu` (`id`, `description`, `entry_datetime`, `name`, `entry_id`) values('11','settings',NULL,'settings',NULL);
